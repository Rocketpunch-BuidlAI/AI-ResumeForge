      ...
      try {
        ...
        const transformedResumes: UploadedResume[] = data.resumes.map(
          (resume: CoverletterResponse) => ({
            ...
            rewardAmount: resume.rewardAmount || 0,
            referenceCount: resume.referenceCount || 0,
        ...
        <TabsContent value="uploaded" className="m-0">
          <Card>
            <CardHeader className="pb-3">
              <CardTitle>Resumes List</CardTitle>
              <CardDescription>List of resumes. Click on a file to view details.</CardDescription>
            </CardHeader>
